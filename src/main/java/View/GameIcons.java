...
/**
 * game icons - images from resources/ resized to terrainsize size
 * @author honzuna
 */
public enum GameIcons {
     ...
     *
     */
    WALL("wall", new ImageIcon(new ImageIcon("resources/terrain_wall.jpg").getImage().getScaledInstance(TerrainSize.WIDTH.getSize(), TerrainSize.HEIGHT.getSize(), Image.SCALE_DEFAULT))),
