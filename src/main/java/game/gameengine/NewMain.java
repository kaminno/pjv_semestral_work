...
public class NewMain {
    ...
    public static void main(String[] args) throws NotEnoughInventoryFreeSpaceException, ItemNotStoredException, ItemEquipedYetException, ItemNotEquipedException, ItemStoredYetException, WrongEquipmentTypeForWearableItemException {
